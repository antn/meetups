...
# Build reusable, testable view components [https://viewcomponent.org]
...
# Heroicons SVG helper for views [https://github.com/bharget/rails_heroicon]
gem "rails_heroicon"

# Authentication via external providers [https://github.com/omniauth/omniauth]
gem "omniauth"
# Mitigate CVE-2015-9284 by requiring POST for auth requests
